...
class MIMLRESettings(CommonModelSettings):
    ...
    def set_static_embedding(self, embedding):
        super(MIMLRESettings, self).set_static_embedding(embedding)
        self.__context_settings.set_static_embedding(embedding)
    ...
    def _internal_get_parameters(self):
        ...
        parameters = [
            ...
            ("mi:RelationLabelCalculationMode", self.RelationLabelCalculationMode),
